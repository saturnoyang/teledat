...
class tc_calendar{
	...
	function writeDay(){
		...
		$str .= "<option value=\"00\"".($this->rtl ? " dir=\"rtl\"" : "").">Dia</option>";
	...
	function writeMonth(){
		...
		$str .= "<option value=\"00\"".($this->rtl ? " dir=\"rtl\"" : "").">Mes</option>";
	...
	function writeYear(){
		...
		$str .= "<option value=\"0000\"".($this->rtl ? " dir=\"rtl\"" : "").">A&ntilde;o</option>";
