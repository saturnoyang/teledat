...
for($day=1; $day<=$total_thismonth; $day++){
	...
	$htmlClass[] = ($is_today) ? "hoy" : "general";
		...
		<div id="calendar-footer">
			...
			<div class="links">
				...
				if($cobj->validTodayDate() && ($m != $cdate->getDate('m') || $y != $cdate->getDate('Y')))
					$footer_links[] = "<a href=\"javascript:today();\" class=\"txt\" alt=\"Today\" title=\"Today\">Hoy</a>";

				if($sld>0 && $slm>0 && $sly>0)
					$footer_links[] = "<a href=\"javascript:unsetValue();\" class=\"txt\" alt=\"Unset\" title=\"Unset\">Liberar</a>";
